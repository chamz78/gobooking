            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Go Booking by')}} <a href="{{__('https://wpdesignerbuddy.com')}}" target="_blank">{{__(' Wp Designer Buddy')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://fiverr.com/wpdesignerbuddy')}}" target="_blank">{{__('Hire on fiverr')}}</a>
                            <a href="{{__('https://wa.me/916900016982?text=I%27m%20interested%20in%20your%20services%20(Code%20GoBooking%20gonetobelize.com)')}}" target="_blank">{{__('Contact on WhatsApp')}}</a>
                        </div>
                    </div>
                </div>
            </div>
