                    ...
                    <div class="panel-body pd15">
                        <div class="row area-setting-row">
                                ...
                                <div class="col-md-4">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc">{{__("Updater Go Booking")}}</span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc">{{__("Plugins for Go Booking")}}</span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            @if($user->hasPermissionTo('system_log_view'))
                                @php $hasAvailableTools = true; @endphp
                                    <div class="area-setting-item">
                                        <a class="setting-item-link" href="https://wpdesignerbuddy.com">
                                        <span class="setting-item-media">
                                            <i class="icon ion-ios-code"></i>
                                        </span>
                                            <span class="setting-item-info">
                                            <span class="setting-item-title">{{__("Developer support")}}</span>
                                            <span class="setting-item-desc">{{__("Visit Developer's website")}}</span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
